...
const sortPower = (arr) => arr.sort((a, b) => a - b)

function areEquallyStrong(yourLeft, yourRight, friendsLeft, friendsRight) {
  const [youLeft, youRight] = sortPower([yourLeft, yourRight])
  const [friendLeft, friendRight] = sortPower([friendsLeft, friendsRight])

  return youLeft === friendLeft && youRight === friendRight
}
