...
function askForMissingDetails(list) {
  ...
  list.forEach((user) => {
    const userWithNull = Object.entries(user)
      .filter((detail) => detail.includes(null))
      .flat()

    const userWithQuestion = {
      ...user,
      question: `Hi, could you please provide your ${userWithNull.at()}.`,
    }
    userWithNull.length && result.push(userWithQuestion)
  })
  return result
}
