...
You can paint an asperand by pixels in three steps:
    ...
    ( the bottom-right corner of the inner square is touching the top-left corner of the pixel ). Let's call it the "bridge".
...
const countPixels = (k) => (k === 1 ? 11 : k === 2 ? 11 + 7 : (k - 2) * 8 + 18)
