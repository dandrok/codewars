...
However, something strange has happened and now
all of the phone numbers contain lots of random characters,
...
const isItANum = (str) => {
  const filterNum = [...str]
    .filter((el) => Number.isFinite(+el) && el !== ' ')
    .join('')
  return filterNum.length === 11 && filterNum[0] === '0'
    ? filterNum
    : 'Not a phone number'
}
