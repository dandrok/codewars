...
However you don't have an 11. You have an unknown there as well.
...
I won't tell you what the other two are, but one of them is: Don't overthink it.
It is a simple solution 

Given the input as a string - Return the sum of the two variables as int.
 */

const placeInTheAlphabet = (letter) => letter.charCodeAt(0) - 96

function theVar(theVariables) {
  const letter = theVariables.split('+')
  return placeInTheAlphabet(letter[0]) + placeInTheAlphabet(letter[1])
}
