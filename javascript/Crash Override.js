...
of their name so your function should accommodate for these grammatical errors.
...
function aliasGen(firstName, surname) {
  const first = fakeFirstName[firstName[0].toUpperCase()]
  const second = fakeSecondName[surname[0].toUpperCase()]
