...
Famous examples include "Amore, Roma", "A man, a plan, a canal: Panama"
and "No 'x' in 'Nixon'". - wikipedia
...
In addition to a few predefined tests, your function will also be tested
against a random string generator 50 times which are guaranteed
to producevalid palindromes.
...
const palindrome = (string) => {
  ...
  const removeNonAlphanumeric = string.replace(/[^a-z0-9]/gi, '')
  const reverseString = [...removeNonAlphanumeric].reverse().join('')
  return removeNonAlphanumeric === reverseString
}
