/* 
Positive integers that are divisible exactly
by the sum of their digits are called Harshad numbers.
...
const numberJoy = (n) => {
  const sum = [...String(n)].reduce((accumu, currValue) => +accumu + +currValue)
  const reverse = [...String(sum)].reverse().join('')
  return n === sum * reverse
}
