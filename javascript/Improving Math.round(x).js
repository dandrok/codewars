...
While some languages (such as PHP) has a round() function that supports rounding to a specified number of decimal places (e.g. <?php round(3.1415926535, 4);
 3.1416 (rounded to 4 d.p. as specified) ?>), Javascript does not!
Task
